...
//    }
    ...
    public ResponseEntity<Long> selezionaPerCategoriaAbito(@RequestParam CategoriaEnum categoria){
        Long numeroProdotto = prodottoService.selezionaPerCategoriaAbito(categoria);
